    ...
    private boolean createShortcutOreo(Context context, String packageName) {
        try {
            ...
            if (shortcutManager.isRequestPinShortcutSupported()) {
                ...
                requestCount++;
                PendingIntent shortcutCallbackIntent = PendingIntent.getBroadcast(context, requestCount, callback, PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE);
